...
cart = request("cart")
%>
<font class="text_header">เข้าสู่ระบบ</font><br>
<form action="submit_login.asp" method="post">
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td colspan="2"><font class="text_normal">ใส่อีเมล์แอดแดรสและรหัสผ่านที่ลงทะเบียนไว้แล้ว</font></td>
  </tr>
  <tr>
    <td width="6%"><div align="right"><font class="text_normal">อีเมล์</font></div></td>
    <td width="94%"><input type="text" name="username" id="username" value=""  /><font class="text_subtitle">ข้อมูลไม่ถูกต้องกรุณาเข้าสู่ระบบใหม่อีกครั้งค่ะ</font></td>
  </tr>
  <tr>
