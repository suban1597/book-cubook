...
sSQL = "SELECT * FROM kidhome_book as bs,booklist as bl WHERE bs.barcode=bl.barcode order by bookid desc"
...
%>
    <td width="162"><div align="center">
                  ...
                  <%ReadBinFile( RS("barcode") & ".jpg")%>
                  <%If Err Then%>
                  <img src="images/book-400/apology.jpg" alt="Book" border="0" height="100"  class="reflect rheight33" />
                  <%Else%>
                  <img src="images/book-400/<%=RS("barcode")%>.jpg"  alt="Book" border="0" height="100"  class="reflect rheight33" />
                  <%End If%>
    </div></td>
...
If currpage > 1 Then
response.write("&nbsp;&nbsp;<a href=""distribute_books.asp?PageNo=" & Prev10 & """ class=pager-next active><<</a> ")
End If
'Work out whether to show the Previous link '<' 
If NOT RSPrevPage = 0 then
response.write("&nbsp;&nbsp;<a href=""distribute_books.asp?PageNo=" & RSPrevPage & """class=pager-next active><</a> ")
End If
...
response.write("<a href=""distribute_books.asp?PageNo=" & P & """class=pager-next active>" & P & "</a> ")
Else
...
response.write("<a href=""distribute_books.asp?PageNo=" & RSNextPage & """class=pager-next active>></a> ")
End If

'Work out whether to show the Next 10 '>>' 
If NOT Next10 = Recordset.PageCount Then
response.write("<a href=""distribute_books.asp?PageNo=" & Next10 & """class=pager-next active>>></a>")
End If
End If
