...
sSQL="SELECT * FROM  booklist  WHERE (disctype = 'C') AND ([language] = 1) AND (distribute = 2) AND (disctype1 = 1)  and stflg <> 2 and (sb14_oh+sb_oh) > 3 order by CONVERT(datetime,recvdate,5) desc" 
