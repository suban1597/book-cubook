...
RS.Open " SELECT OrderID,OrderDate,OrderTime,UserID,Name,Address,City,Province,Zip,Country,Phone,place,num,moo,building,soi,road,tumbon,orderstatus,ShipmentStatus,PaymentMethod,delivery,Amount,SAHC,MoneyUnit FROM orders" , Conn, 1, 3
