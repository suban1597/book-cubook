...
'response.Write book_id
	...
	sql = "select book_id,book_thumbnail_path,book_name,book_author,book_file_size,category,book_bath_price,description from Ebooklist where book_id = '"&book_id&"' "
	'response.Write sql
                ...
                <tr>
                  <td valign="top">
                     ...
                     <form id="free-load" name="free-load" method="post" action="free_download_api.asp">
            					 ...
            					 <span class="blacktext"><b><u>Apple IOS , Android :</u></b><input type="image" src="images/icons/download2.png" id="bt_download" name="bt_download" border="0" /></span></br>
                     </form>
                <% if RS_Ebookdis("book_id") = "1613" OR RS_Ebookdis("book_id") = "4702" then %>
                    <div style="border-bottom:medium"><b><u>PDF On Computer :</u></b> <img src="http://www.chulabook.com/images/down.jpg" width="20" height="20" align="absbottom" /> <a href="http://www.chulabook.com/word/<%=RS_Ebookdis("book_id")%>.pdf" target="_blank">ดาวน์โหลด</a></div>
                <% end if %>
            <%
