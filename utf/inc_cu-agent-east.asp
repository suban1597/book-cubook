...
SSql = "SELECT * FROM wholesale_shop  WHERE part like 'ภาคตะวันออก'" 
...
%>
    <td width="162" valign="top"><div align="east">    <%
	...
	%></div></td>
    <td width="837" valign="top"><span class="bluetext"><b><br />
      <%=Recordset("shopname")%></b></span>
...
If currpage > 1 Then
response.write("&nbsp;&nbsp;<a href=""cu-agent-east.asp?PageNo=" & Prev10 & """ class=pager-next active><<</a> ")
End If
'Work out whether to show the Previous link '<' 
If NOT RSPrevPage = 0 then
response.write("&nbsp;&nbsp;<a href=""cu-agent-east.asp?PageNo=" & RSPrevPage & """class=pager-next active><</a> ")
End If
...
response.write("<a href=""cu-agent-east.asp?PageNo=" & P & """class=pager-next active>" & P & "</a> ")
Else
...
response.write("<a href=""cu-agent-east.asp?PageNo=" & RSNextPage & """class=pager-next active>></a> ")
End If

'Work out whether to show the Next 10 '>>' 
If NOT Next10 = Recordset.PageCount Then
response.write("<a href=""cu-agent-east.asp?PageNo=" & Next10 & """class=pager-next active>>></a>")
End If
End If
