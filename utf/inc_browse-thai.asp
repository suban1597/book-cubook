...
sSQL=sSQL&" WHERE (category ='"&lower& "') and language=1 and (sb14_oh+sb_oh)>1"
...
If currpage > 1 Then
response.write("&nbsp;&nbsp;<a href=""browse-thai.asp?upper="&upper&"&amp;lower="&lower&"&amp;PageNo=" & Prev10 & """ class=pager-next active><<</a> ")
End If
'Work out whether to show the Previous link '<' 
If NOT RSPrevPage = 0 then
response.write("&nbsp;&nbsp;<a href=""browse-thai.asp?upper="&upper&"&amp;lower="&lower&"&amp;PageNo=" & RSPrevPage & """class=pager-next active><</a> ")
End If
...
response.write("<a href=""browse-thai.asp?upper="&upper&"&amp;lower="&lower&"&amp;PageNo=" & P & """class=pager-next active>" & P & "</a> ")
Else
...
response.write("<a href=""browse-thai.asp?upper="&upper&"&amp;lower="&lower&"&amp;PageNo=" & RSNextPage & """class=pager-next active>></a> ")
End If

'Work out whether to show the Next 10 '>>' 
If NOT Next10 = Recordset.PageCount Then
response.write(" <a href=""browse-thai.asp?upper="&upper&"&amp;lower="&lower&"&amp;PageNo=" & Next10 & """class=pager-next active>>></a></div>")
End If
End If
