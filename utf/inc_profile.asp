...
<%
Sql = "SELECT Bname, Userid, Birthday, Gender, statusupdate, BAddress, BCity, Binterprovince, Bzip, BPhone, Sname, SAddress, SCity, SZip, bplace, bnum, bmoo, bbuilding, bsoi, broad, btumbon, BProvince, splace, snum, smoo, sbuilding, ssoi, sroad, stumbon, SPhone, information, SProvince, Sinterprovince, SCountry, BCountry FROM account WHERE (UserID ='" & Session("UserID") & "')"
...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
    <tr>
    <td valign="top"><form id="register" name="register" method="post" onsubmit="return(foul.validate(this))" action="utf/update_profile.asp" >
                ...
                <tr>
                  <td height="34"><table width="95%" border="0" align="center" cellpadding="2" cellspacing="2" class="text">
                    <tr>
                      ...
                      <div align="left">&nbsp;
                          <input name="information" type="radio" value="0" <%=check0%> />ต้องการ &nbsp;
						  <input name="information" type="radio" value="1" <%=check1%>/>ไม่ต้องการ
                      </div>
                      </td>
                    </tr>
