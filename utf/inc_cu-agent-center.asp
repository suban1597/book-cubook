...
SSql = "SELECT * FROM wholesale_shop  WHERE part like '%ภาคกลาง%'" 
...
If currpage > 1 Then
response.write("&nbsp;&nbsp;<a href=""cu-agent-center.asp?PageNo=" & Prev10 & """ class=pager-next active><<</a> ")
End If
'Work out whether to show the Previous link '<' 
If NOT RSPrevPage = 0 then
response.write("&nbsp;&nbsp;<a href=""cu-agent-center.asp?PageNo=" & RSPrevPage & """class=pager-next active><</a> ")
End If
...
response.write("<a href=""cu-agent-center.asp?PageNo=" & P & """class=pager-next active>" & P & "</a> ")
Else
...
response.write("<a href=""cu-agent-center.asp?PageNo=" & RSNextPage & """class=pager-next active>></a> ")
End If

'Work out whether to show the Next 10 '>>' 
If NOT Next10 = Recordset.PageCount Then
response.write("<a href=""cu-agent-center.asp?PageNo=" & Next10 & """class=pager-next active>>></a>")
End If
End If
