...
'If {{  CheckOut }}
If Action="Next>>" Then
	Response.Redirect("13082019_test_CheckOutV2.asp")
End if
...
<%
	...
	RS.Open Sql,conn,1,3
%>
	<form id="form1" name="form1" method="post" onsubmit="return(foul.validate(this))" action="13082019_test_checkoutV2.asp">
	        ...
	        <% end if %>
	              ...
	              <br />
	                ...
	                <p align="center">
	                  ...
	                  <a href="http://www.chulabook.com/13082019_test_shopping.asp"><input name="action" type="button" id="action" value="&lt;&lt; ย้อนกลับ" onClick="http://www.chulabook.com/shopping.asp" /></a>
