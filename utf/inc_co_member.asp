...
SSql = "SELECT * FROM co_member  WHERE hit = 1 ORDER BY  TID,title DESC" 
...
%>
    <td width="162" valign="top"><div align="center"><img src="images/comember/<%=Recordset("mid")%>.jpg"  alt="Book" border="0" class="reflect rheight33" width="170px" /></div></td>
    <td width="837" valign="top"><span class="bluetext"><b><%=Recordset("Title")%></b></span>
    <br><span class="blacktext"><%=Recordset("Extra")%>
    <br><span class="blacktext"><%=Recordset("url")%>
...
If currpage > 1 Then
response.write("&nbsp;&nbsp;<a href=""member_co.asp?PageNo=" & Prev10 & """ class=pager-next active><<</a> ")
End If
'Work out whether to show the Previous link '<' 
If NOT RSPrevPage = 0 then
response.write("&nbsp;&nbsp;<a href=""member_co.asp?PageNo=" & RSPrevPage & """class=pager-next active><</a> ")
End If
...
response.write("<a href=""member_co.asp?PageNo=" & P & """class=pager-next active>" & P & "</a> ")
Else
...
response.write("<a href=""member_co.asp?PageNo=" & RSNextPage & """class=pager-next active>></a> ")
End If

'Work out whether to show the Next 10 '>>' 
If NOT Next10 = Recordset.PageCount Then
response.write("<a href=""member_co.asp?PageNo=" & Next10 & """class=pager-next active>>></a>")
End If
End If
