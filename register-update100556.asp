...
<script type="text/javascript">
    function chkdata()<!--chkdata คือ ชื่อ function-->
    {
        with(form1)<!--with คือ การเลือกตำแหน่งซึ่งในที่นี้คือ form1-->
        {
            ...
            if(bphone.value==''){
               alert(" กรอก เบอร์โทร ด้วย ค่ะ");bphone.focus();
               return false;
         	}	
            if(bname.value==''){
               alert(" กุรุณากรอก ชื่อ-นามสกุล ด้วย ค่ะ");bname.focus();
            ...
            if(splace.value==''){
               alert(" กรอก ชื่อสถานที่ ด้วย ค่ะ");splace.focus();
               return false;
         	}
            if(snum.value==''){
            ...
            if(smoo.value==''){
               alert(" กรอก หมู่ ด้วย ค่ะ");smoo.focus();
               return false;
         	}
            if(sbuilding.value==''){
            ...
            if(ssoi.value==''){
               alert(" กรอก ซอย ด้วย ค่ะ");ssoi.focus();
               return false;
         	}		
            if(sroad.value==''){
               alert(" กรอก ถนน ด้วย ค่ะ");sroad.focus();
               return false;
         	}
            if(stumbon.value==''){
               alert(" กรอก ตำบล ด้วย ค่ะ");stumbon.focus();
               return false;
         	}
            if(scity.value==''){
               alert(" กรอก อำเภอ/เขต ด้วย ค่ะ");scity.focus();
               return false;
         	}
            if(sprovince.value==''){
               alert(" กรอก จังหวัด ด้วย ค่ะ");sprovince.focus();
               return false;
         	}
            if(szip.value==''){
               alert(" กรอก รหัสไปรษณีย์ ด้วย ค่ะ");szip.focus();
               return false;
         	}																											
    	}
    }
