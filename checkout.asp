...
<form name="final" method="post" action="final.asp">
...
<br>
              ...
              <!-- ขอใบเสร็จลดหย่อนภาษี -->
                <!--table width="95%" border="0" align="center" cellpadding="2" cellspacing="2" class="blacktext">
                  <tr>
                    <td class="big-text"><div align="left"><strong>ขอใบเสร็จลดหย่อนภาษี ตั้งแต่วันที่ 15 ธ.ค. 61 - 16 ม.ค. 62 </strong></div></td>
                    </tr>
                    <tr>
                      <td>
                        <div id="clickme4">
