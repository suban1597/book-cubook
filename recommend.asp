...
' Page Data 
' =======================
sql = "select top 10 * from book_recommend as br, booklist as bl"
sql = sql & " where book_type = 'recommend' and br.barcode = bl.barcode order by postdate desc"
Set RS = Server.CreateObject("ADODB.RecordSet")
RS.Open Sql,conn,1,3
' =======================
%>
<font class="text_header">หนังสือแนะนำ</font>
	      <%Do While not rs.EOF%>
